...
@Component({
  selector: 'app-acceuil-employer',
  templateUrl: './acceuil-employer.component.html',
  styleUrls: ['./acceuil-employer.component.css']
})
export class AcceuilEmployerComponent {
  sessionModele: any;
  modalDisplay = 'none';
  hiddenValue: string = '';
  id: any;
